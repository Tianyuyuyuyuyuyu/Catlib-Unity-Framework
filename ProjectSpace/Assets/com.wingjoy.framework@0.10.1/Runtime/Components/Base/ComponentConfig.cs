...
namespace Wingjoy.Framework.Runtime.Base
{
    public class ComponentConfig : MonoBehaviour
    {
        ...
        internal static void RegisterComponent(ComponentConfig wingjoyFrameworkHotFixComponent)
        {
            ...
            {
                ComponentConfigDic.Add(key, wingjoyFrameworkHotFixComponent);
            }
        }
    }
}