...
namespace Wingjoy.Framework.Editor.Localization
{
    ...
    public class ExportNotTranslated : GlobalConfig<ExportNotTranslated>
    {
        ...
        {
            var folder = Path.GetDirectoryName("Assets/WingjoyData/Framework/Localization/NotTranslated/");
        ...
        {
            var folder = Path.GetDirectoryName("Assets/WingjoyData/Framework/Localization/CompareResult/");
            if (!Directory.Exists(folder))
            {
                Directory.CreateDirectory(folder);
            }
        ...
        {
            var folder = Path.GetDirectoryName("Assets/WingjoyData/Framework/Localization/Text/");
            if (!Directory.Exists(folder))
            {
                Directory.CreateDirectory(folder);
            }
