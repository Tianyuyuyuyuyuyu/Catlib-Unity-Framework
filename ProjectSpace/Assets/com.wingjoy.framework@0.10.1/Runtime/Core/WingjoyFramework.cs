...
#if UNITY_EDITOR
using Wingjoy.Framework.Runtime.HotFix;
#endif

namespace Wingjoy.Framework.Runtime
{
    public partial class WingjoyFramework : SerializedMonoBehaviour
    {
        /// <summary>
        /// 核心
        /// </summary>
        ...
        public async UniTask LauncherMain()
        {
            ...
            await WingjoyFrameworkComponent.OnLauncher();
        }
        ...
        public async UniTask LauncherHotFix()
        {
            ...
            {
                ILRuntimeWrapper.AppDomain.Invoke("Wingjoy.Framework.Runtime.HotFix.CoreHotFix", "StartGame", null,
                    new object[] {this, CoreHotFixType, mainTypes, ILRuntimeWrapper.GetHotfixTypes().ToArray()});
            }
            else
            {
                Type.GetType("Wingjoy.Framework.Runtime.HotFix.CoreHotFix").GetMethod("StartGame").Invoke(null, new object[] {this, CoreHotFixType, mainTypes, mainTypes});
            }
            ...
            if (Mode == LauncherMode.HotFix)
            {
                ILRuntimeWrapper.AppDomain.Invoke("Wingjoy.Framework.Runtime.HotFix.WingjoyFrameworkHotFixComponent", "OnLauncher", null);
            }
            else
            {
                Type.GetType("Wingjoy.Framework.Runtime.HotFix.WingjoyFrameworkHotFixComponent").GetMethod("OnLauncher").Invoke(null, null);
            }
        }
