...
namespace Wingjoy.Framework.Runtime.Audio
{
    public class AudioLibrary : ScriptableObject
    {
...
#if UNITY_EDITOR
        private const string nameSpaceName = "Wingjoy.Framework.Runtime.Audio";

        public void GenerateAudioLibrary()
        {
            string fileName = $"AudioId - {m_LibraryName}.cs";
            string filePath = $"{RuntimeUtilities.Path.WingjoyDataPath}/Framework/Audio/Script/{fileName}";
        ...
        public int GetAudioIds(AudioClipObject audioClipObject, AudioGroupType audioGroupType)
        {
            ...
            var className = $"Wingjoy.Framework.Runtime.Audio.{m_LibraryName}{suffix}s";
